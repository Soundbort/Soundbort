...
import AdminPermissions from "../../core/permissions/AdminPermissions";
...
export default function uploadCmdGenerator(admin: AdminPermissions) {
    return new SlashSubCommandGroup({
        name: "upload",
        ...
        commands: [
            new SlashSubCommand({
                ...
                async func(interaction) {
                    ...
                    await upload(admin, interaction, name, SAMPLE_TYPES.STANDARD);
                },
            }),
        ],
    });
